...
<header class="bg-black">
  <nav class="mx-auto max-w-7xl flex items-center justify-between px-6 lg:px-4 py-5">
    ...
    <div class="hidden lg:flex items-center gap-8">
      ...
      {{-- Show additional links only when logged in --}}
      @auth
        {{-- Replace routes here with your actual routes or anchors --}}
        <a href="{{ route('customer.track') }}" class="text-gray-300 hover:text-white">Track Repair</a>
        <a href="{{ route('customer.messages') }}" class="text-gray-300 hover:text-white">Messages</a>
      @endauth
    </div>
    {{-- Authentication controls / user menu --}}
            ...
            >
              <div class="p-2">
                ...
                <a 
                    ...
                    class="flex items-center px-3 py-2 text-sm text-gray-700 transition-colors duration-150 rounded-lg hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700"
                >
                ...
                <form method="POST" action="{{ route('logout') }}">
                  ...
                  <button 
                      type="submit"
                      class="flex items-center w-full px-3 py-2 text-sm text-red-600 transition-colors duration-150 rounded-lg hover:bg-red-50 dark:text-red-400 dark:hover:bg-red-900/20"
                  >
