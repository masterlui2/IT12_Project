                        ...
                        <td class="px-4 py-3 text-center">
                            <div class="inline-flex gap-2 justify-center">
                                ...
                                @if($job->status === 'in_progress')
                                    <form action="{{ route('technician.job.mark-complete', $job->id) }}" method="POST" class="inline">
                                        @csrf @method('PATCH')
                                        <button class="text-green-600 hover:text-green-800" title="Mark As Completed"><i class="fas fa-check"></i></button>
                                    </form>
                                @endif
                            </div>
                        </td>
