...
<div class="min-h-screen py-4">
    <div class="max-w-6xl mx-auto px-6 w-full">
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
            ...
            {{-- Top: Header --}}
            <div class="relative p-6 border-b border-gray-200 bg-gradient-to-r from-blue-50 to-gray-50">
                {{-- Top row: Logo + Brand Name, Dashboard Button --}}
                <div class="flex items-center justify-between mb-4">
                    ...
                    <a href="{{ route('technician.dashboard') }}" class="text-xs text-gray-500 hover:text-blue-600 transition-colors whitespace-nowrap">
                        ← {{ __('Dashboard') }}
                    </a>
                </div>
                ...
                <div class="flex items-center justify-between">
                    ...
                    <h2 class="text-sm font-bold text-blue-600 whitespace-nowrap">
                        {{ __('Service Request') }}
                    </h2>
                </div>
            </div>
            ...
            <div class="p-6 bg-white max-h-[70vh] overflow-y-auto">
                    {{-- Success Message --}}
                    @if(session('success'))
                        <div class="mb-4 rounded-lg border border-green-500 bg-green-50 px-3 py-2 text-xs text-green-700">
                            {{ session('success') }}
                        </div>
                    @endif
                    ...
                    {{-- Error Display --}}
                    @if($errors->any())
                        <div class="mb-4 rounded-lg border border-red-500 bg-red-50 px-3 py-2 text-xs text-red-700">
                    ...
                    <form action="{{ route('technician.inquire.store') }}" method="POST" enctype="multipart/form-data" class="space-y-5">
                        @csrf

                        {{-- Section 1: Contact Information --}}
                        <div class="space-y-3">
                            <h3 class="text-sm font-semibold text-blue-600 uppercase tracking-wide flex items-center gap-2">
                                <span class="flex h-6 w-6 items-center justify-center rounded-full bg-blue-100 text-blue-600 text-xs">1</span>
                            ...
                            <div class="grid sm:grid-cols-2 gap-3">
                                ...
                                <div>
                                    ...
                                    <input type="text" 
                                           name="name"
                                           class="w-full bg-white border border-gray-300 rounded-lg px-4 py-3 text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
                        ...
                        <div class="space-y-3">
                            <h3 class="text-sm font-semibold text-blue-600 uppercase tracking-wide flex items-center gap-2">
                                <span class="flex h-6 w-6 items-center justify-center rounded-full bg-blue-100 text-blue-600 text-xs">2</span>
                                {{ __('Service Details') }}
                            </h3>
                            ...
                            <div>
                                ...
                                <textarea name="issue_description"
                                          rows="3"
                                          class="w-full bg-white border border-gray-300 rounded-lg px-4 py-3 text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors resize-none"
                        ...
                        <div class="space-y-3">
                            <h3 class="text-sm font-semibold text-gray-500 uppercase tracking-wide flex items-center gap-2">
                                <span class="flex h-6 w-6 items-center justify-center rounded-full bg-gray-100 text-gray-500 text-xs">3</span>
                                {{ __('Additional') }}
                            ...
                            <div class="grid sm:grid-cols-3 gap-3">
                                ...
                                <div>
                                    ...
                                    <input type="file" 
                                           name="photo"
                                           accept="image/*"
                                           class="w-full bg-white border border-gray-300 rounded-lg px-4 py-3 text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors file:mr-3 file:py-1 file:px-3 file:rounded file:border-0 file:text-xs file:bg-blue-600 file:text-white hover:file:bg-blue-700 file:transition-colors">
                                    @error('photo')
                                        <p class="text-xs text-red-500 mt-1">{{ $message }}</p>
                                    @enderror
                                </div>
                        ...
                        <div class="pt-2">
                            <button type="submit"
                                    class="w-full bg-blue-600 hover:bg-blue-500 active:bg-blue-700 transition-colors px-4 py-2.5 rounded-lg text-sm font-semibold text-white shadow-lg shadow-blue-900/20 hover:shadow-blue-900/30">
                                {{ __('Submit Inquiry') }} ✓
                            </button>
                        </div>
                    </form>
